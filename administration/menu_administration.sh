...
menu_admin(){
    ...
    while true; do
        ...
        case "$choice" in
            ...
            chmod +x $HOME/AdminSysTools/administration/scripts/createuser.sh
            ...
            bash $HOME/AdminSysTools/administration/scripts/createuser.sh || result=$?
            ;;
            2)
            chmod +x $HOME/AdminSysTools/administration/scripts/deluser.sh
            bash $HOME/AdminSysTools/administration/scripts/deluser.sh || result=$?
            ;;
            3)
            chmod +x $HOME/AdminSysTools/administration/scripts/changeIP.sh
            bash $HOME/AdminSysTools/administration/scripts/changeIP.sh || result=$?
            ;;
            4)
            chmod +x $HOME/AdminSysTools/administration/scripts/confsudo.sh
            bash $HOME/AdminSysTools/administration/scripts/confsudo.sh || result=$?
            ;;
            5)
            chmod +x $HOME/AdminSysTools/administration/scripts/changedroits.sh
            bash $HOME/AdminSysTools/administration/scripts/changedroits.sh || result=$?
            ;;
            6)
            chmod +x $HOME/AdminSysTools/administration/scripts/confssh.sh
            bash $HOME/AdminSysTools/administration/scripts/confssh.sh || result=$?
            ;;
            7)
            chmod +x $HOME/AdminSysTools/administration/scripts/confDNS.sh
            bash $HOME/AdminSysTools/administration/scripts/confDNS.sh || result=$?
            ;;
            8)
            chmod +x $HOME/AdminSysTools/administration/scripts/confDHCP.sh
            bash $HOME/AdminSysTools/administration/scripts/confDHCP.sh || result=$?
            ;;
            9)
            chmod +x $HOME/AdminSysTools/administration/scripts/routing.sh
            bash $HOME/AdminSysTools/administration/scripts/routing.sh || result=$?
            ;;
            10)
            chmod +x $HOME/AdminSysTools/administration/scripts/FTPconfig.sh
            bash $HOME/AdminSysTools/administration/scripts/FTPconfig.sh || result=$?
            ;;
            11)
